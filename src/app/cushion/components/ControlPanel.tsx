...
const YouTubeEmbed = dynamic(() => import('react-social-media-embed').then((mod) => ({ default: mod.YouTubeEmbed })), {
  ssr: false,
  loading: () => <div>Loading YouTube video...</div>,
});

const InstagramEmbed = dynamic(() => import('react-social-media-embed').then((mod) => ({ default: mod.InstagramEmbed })), {
  ssr: false,
  loading: () => <div>Loading Instagram post...</div>,
});
