  ...
  return (
    <>
      <div className="flex flex-row gap-x-4 items-center mt-4">
        ...
        />
        <div>
          <Input type={InputStyleType.Checkbox} checked={showLabel} onChange={() => setShowLabel(!showLabel)} />
          <span className="text-background">文字</span>
        </div>

        <div>
          <Input type={InputStyleType.Checkbox} checked={showMark} onChange={() => setShowMark(!showMark)} />
          <span className="text-background">記號</span>
        </div>

        <div>
          <Input type={InputStyleType.Checkbox} checked={showDot} onChange={() => setShowDot(!showDot)} />
